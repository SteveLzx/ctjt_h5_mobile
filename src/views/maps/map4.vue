...
<svg width="${width}px" height="${height}px"
  ...
  version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <g id="训练场24">
      <line x1="${rotateTransList[0][0]}" y1="${rotateTransList[0][1]}" x2="${rotateTransList[3][0]}" y2="${rotateTransList[3][1]}"
        style="stroke:rgb(99,99,99);stroke-width: 0.2"/>
      <line x1="${rotateTransList[1][0]}" y1="${rotateTransList[1][1]}" x2=" ${rotateTransList[2][0]}" y2="${rotateTransList[2][1]}"
        style="stroke:rgb(99,99,99);stroke-width: 0.2"/>
      <line x1="${rotateTransList[0][0]}" y1="${rotateTransList[0][1]}" x2="${rotateTransList[1][0]}" y2="${rotateTransList[1][1]}"
      ...
      <line x1=" ${rotateTransList[2][0]}" y1="${rotateTransList[2][1]}" x2="${rotateTransList[3][0]}" y2="${rotateTransList[3][1]}"
        stroke-dasharray="0.4,0.4" style="stroke:rgb(99,99,99);stroke-width: 0.2"/>
      <text text-anchor="middle" dominant-baseline="central" fill="red" transform="translate(${rotateTransText[0]} ${rotateTransText[1]}) scale(0.15 0.15)">24</text>
    </g>
</svg>
        `}}
      </xmp>
